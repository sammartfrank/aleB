...
var results = [
	{id:16, title:'KITCHEN ANGELS', subtitle: 'This project is a TV-show for Food Network channel. Took full responsibility for production, selling and direction of the project. Originally a pilot that became acquired by Scripps Networks Interactive to air on Food Network’s roster. It involves every stage of the marketing spectrum. We started with a hand-drawn logo and character design.', parraf:"", imagenes: [LogoLADLC,CharactersLADLC], videos: []},
