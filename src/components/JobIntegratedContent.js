...
var results = [
	...
	{id:16, title:'', subtitle: 'Produced an opening to kick off with the brand concept and for maximum brand impact.', parraf:"", imagenes: [], videos: [OpeningLADLC]},
	{id:18, title:'', subtitle: 'Instagram and Facebook were programmed to feed the YouTube channel with subscribers. Media was synched with air premiere schedule. -- Visit Instagram profile --Visit YouTube channel', insta:['https://www.instagram.com/losangelesdelacocina'], yot:['https://www.youtube.com/channel/UCtbAtJgZhlaJ8eGqeEARJpQ/featured'], parraf:"", imagenes: [], videos: [YTLADLC,IGLADLC,PremiereLADLC]},
