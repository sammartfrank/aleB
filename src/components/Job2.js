...
var results = [
	{title:'KITCHEN ANGELS', subtitle: 'This project started with a naming that would keep cooking close to people, we drove that into a hand-drawn logo.', parraf:"", imagenes: [], videos: []},
	{title:'NIETOTEST',subtitle:'-Nieto- stands for grandchildren. This project consists of a website that contains a customizable and printable memotest.', parraf:"The aim was to give tools to families and help them share with their grandparents, even if they are going through Alzheimer’s disease. ", imagenes: [], videos: []},
	{title:'FIRST CHAPTER', subtitle: 'This publishing house needed some kind of sales boost so we came up with First Chapter. Sampling in a category not yet used.', parraf:"", imagenes: [], videos: []},
	];
