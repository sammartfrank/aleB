...
var results = [
	...
	{id:2, title:'TENTACIONES COOKIES', subtitle:'The brand needed to launch a limited edition of already known Tentaciones with a new chocolate filling. We created a "Yes, but NO" concept execution to make them more irresistible.',parraf:"", imagenes:[], videos:[videoMonsi]},
	{id:3, title:'FIAT DOGS', subtitle: 'Fiat needed to advertise their new Diesel engine with less fuel consumption in one of their utilitaries: Fiat Strada. The concept works on the product advantage with impact and sense of humour.', parraf:"", imagenes: [graficaBobby,graficaLisa],},
 ...
 {id:5, title:'PIM', subtitle: 'Client asked us to launch a new payment platform that works as a virtual wallet and can be used with any celphone, even if it\'s not a smartphone. So we worked on a looping system of pieces that made clear how simple the system is.', parraf:"", imagenes: [], videos: [videoPim1,videoPim2,videoPim3,videoPim4,videoPim5]},
	...
	{id:9, title:'THE END', subtitle:'Client wanted to be very clear about the power of their product among others. Through a satiric execution we could tell the product benefits with humour and aesthetic impact.', parraf:"", imagenes:[], videos:[videoProtech]},
	{id:10, title:'FRIZZE', subtitle: 'The brand was lauching their Facebook page. We created an -organization- for youngsters to join and be part of this movement called JODA, which stands for PARTY in english. Members could create their own member card and use it in brand exclusive events.',parraf:"", imagenes: [], videos: [videoFrizze]},
	...
	{id:14, title:'BONOBON', subtitle: 'These were my first :3, sorry for video quality. We worked for this brand, which has strong emotional values, for special dates such as Mother\'s day or Holidays.',parraf:"", imagenes: [], videos: [videoBonobon1,videoBonobon2]},
];
