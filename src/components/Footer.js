...
const Footer = () => {
	return (
			<div className="contact">
				<video src={video} autoPlay muted loop style={{width:'8em', height:'8em', marginTop:'3em', marginBottom:'3em'}}/>
				<div className="info">
				<h3>Write</h3>
				<a href="mailto:alebarredo@gmail.com"><p style={{fontFamily: 'Kameron'}}>ale.barredo@gmail.com</p></a>
				<br />
				<h3>Call</h3>
				<p style={{fontFamily: 'Kameron'}}>+54 9 11 55771850</p>	
				<br />
				<h3 style={{marginTop:'2em', fontSize:'1.7em'}}>Stick Around</h3>
				<ul>
					<li>
